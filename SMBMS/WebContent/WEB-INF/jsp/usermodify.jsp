		       ...
		       <div>
                ...
                <div>
                	...
                	<c:choose>
	            		...
	            		<c:otherwise>
	            			<img width="300" height="350" src="${pageContext.request.contextPath }/statics/uploadfiles/${user.idPicPath}"/>
	            		</c:otherwise>
           			</c:choose>
                </div>
               <div>
	               ...
	               <c:choose>
	            		<c:when test="${user.workPicPath == null || user.workPicPath == ''}">
	               		...
	               		<c:otherwise>
	            			<img width="300" height="350" src="${pageContext.request.contextPath }/statics/uploadfiles/${user.workPicPath}"/>
	                    </c:otherwise>
	                </c:choose>
                </div>
