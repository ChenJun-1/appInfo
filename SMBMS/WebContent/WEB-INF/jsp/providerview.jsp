 ...
 <div class="right">
        ...
        <div class="providerView">
            ...
            <c:choose>
            	...
            	<c:otherwise>
            		<img width="300" height="350" src="${pageContext.request.contextPath }/statics/uploadfiles/${provider.companyLicPicPath}"/>
            	</c:otherwise>
            </c:choose>
            </span></p>
            ...
            <c:choose>
            	...
            	<c:otherwise>
            		<img width="300" height="350" src="${pageContext.request.contextPath }/statics/uploadfiles/${provider.orgCodePicPath}"/>
            	</c:otherwise>
            </c:choose>
            </span></p>
